/**
 * ExpenseCategoriesPage.jsx - Gestion des catégories de dépenses
 *
 * Fonctionnalités:
...
export default function ExpenseCategoriesPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingCategory) {
        // Modification
        const categoryRef = ref(database, `universities/${userProfile.universityId}/accounting/expenseCategories/${editingCategory.id}`);
      ...
      setFormData({ label: '', value: '', color: 'blue' });
  ...
  const handleDelete = async (categoryId) => {
    ...
    try {
      const categoryRef = ref(database, `universities/${userProfile.universityId}/accounting/expenseCategories/${categoryId}`);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl hover:shadow-lg transition flex items-center gap-2 font-semibold"
          >
