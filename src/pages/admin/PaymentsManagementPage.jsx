  ...
  const handleMarkAsPaid = async (payment) => {
    ...
    try {
      ...
      if (paymentsSnap.exists()) {
        ...
        paymentData.installments[payment.installmentIndex].status = 'paid';
        paymentData.installments[payment.installmentIndex].paidDate = now;
        paymentData.installments[payment.installmentIndex].paymentMethod = selectedMethod;
        paymentData.installments[payment.installmentIndex].paidBy = currentUser?.uid || userProfile?.uid;
        paymentData.installments[payment.installmentIndex].processedBy = userProfile?.displayName;
      ...
      if (paymentsSnap.exists()) {
        ...
        for (const installment of pendingInstallments) {
          ...
          if (remainingAmount >= installmentAmount) {
            ...
            paymentData.installments[installment.originalIndex].paidBy = currentUser?.uid || userProfile?.uid;
